...
public class TestLibraryBook {
   ...
   public static void main( String[] args)
   {
      ...
      //program code
      book1 = new LibraryBook( "Hayatta Kalma Rehberi", "Zehra Çelenk");
      book2 = new LibraryBook( "Sonrasý Kalýr", "Edip Cansever");
      book3 = new LibraryBook( "Ondancý", "M. Sadýk Aslankara");
      book4 = book2;
      book5 = new LibraryBook( "Sonrasý Kalýr", "Edip Cansever");
